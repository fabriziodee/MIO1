module.exports = {
  name: "stalk",
  alias: ["sh", "stalkwhatsapp", "stalknumber"],
  desc: "Cerca un numero di whatsapp in un determinato intervallo",
  ...
  start: async (Miku, m, { pushName, args, prefix }) => {
    ...
    if (!inputnumber.includes("x")) return m.reply("Non hai aggiunto x");
    if (inputnumber.includes("xxxx")) return m.reply("Sono consentite al massimo 3 'x'! Per evitare il divieto!");
    m.reply(
      `Ricerca di account WhatsApp in un determinato intervallo...\n\nAttendi un minuto...`
    );
    ...
    var nomerny = `        *『 Elenco dei numeri Whatsapp 』*\n\n`;
    var nobio = `\n🎀 *Bio:* Ehilà! Sto usando WhatsApp.\n\n`;
