...
let handler = async (m, { conn, text }) => {
    ...
    if (!m.quoted && !text) throw '*_Inserisci un testo o rispondi a qualsiasi file multimediale_*'
    ...
    m.reply('*✅ Stato caricato correttamente, pianifica il numero del Bot nella tua lista dei contatti e chiedi al proprietario del Bot di aggiungerti ai suoi contatti in modo da poter vedere gli stati*')
    }
handler.help = ['subirestado']
handler.tags = ['General']
handler.command = /^subi$/i
