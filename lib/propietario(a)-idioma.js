...
let texto = `*La lingua del GataBot è cambiata correttamente:* `
let texto2 = `*Seleziona la lingua per GataBot*`
let texto3 = `*I Comandi non cambieranno la Lingua, solo il contenuto del Messaggio*`
...
const sections = [{
title: '✨LINGUE DISPONIBILI : LINGUE DISPONIBILI✨',
rows: [
...
await m.reply(`${fg}\`\`\`IMPOSSIBILE CAMBIARE LINGUA, SEGNALARE QUESTO COMANDO ${usedPrefix + command} CON IL COMANDO ${usedPrefix}reporte\`\`\``) 
console.log(e) 
}}
