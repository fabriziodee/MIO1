...
this.sendButton(id, text, groupMetadata.subject, apii.data, [[(action == 'add' ? 'HEY PUPA 👋' : ' ADDIO COLLLLLIONE 🚮'), (action == 'add' ? '.ok' : '.llorar')]], null, {mentions: this.parseMention(text)})
