...
this.sendButton(id, text, groupMetadata.subject, apii.data, [[(action == 'add' ? 'HEY PUPA 👋''HEY PUPO 👋' : ' ADDIO COLLLLLIONA 🚮'' ADDIO COLLLLLIONE 🚮'), (action == 'add' ? '.ok' : '.llorar')]], null, {mentions: this.parseMention(text)})
